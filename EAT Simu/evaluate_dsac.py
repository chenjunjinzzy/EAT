...
module_path = f"res_policy/2_0.05_0.05_4_10_[1, 2, 4]/dsac_policy.pth"
res_path = None
data_path = None
...
if __name__ == '__main__':
    for task_arrival_rate in [0.01, 0.03 ,0.05, 0.07, 0.09, 0.11]:
        res_path = f"statistic/{node_num}/{task_arrival_rate}_{node_num}_{queue_len}_{co_num}_{time_limit}/dsac_res.csv"
        data_path = f"statistic/{node_num}/{task_arrival_rate}_{node_num}_{queue_len}_{co_num}_{time_limit}/dsac_data.csv"
        task_arrival_rate = task_arrival_rate
        main()
