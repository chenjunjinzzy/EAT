...
from diffusion.model import MLP, AttentionMLP
...
if __name__ == '__main__':
    for task_arrival_rate in [0.01, 0.03 ,0.05, 0.07, 0.09, 0.11]:
        res_path = f"statistic/{node_num}/{task_arrival_rate}_{node_num}_{queue_len}_{co_num}_{time_limit}/adsac_res.csv"
        data_path = f"statistic/{node_num}/{task_arrival_rate}_{node_num}_{queue_len}_{co_num}_{time_limit}/adsac_data.csv"
        main()
